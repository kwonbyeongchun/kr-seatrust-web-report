    ...
    <Slide number={2}>
      ...
      <div style={{ marginTop: '1.5rem', textAlign: 'left', width: '100%' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
          <div>
            <p style={{ marginBottom: '0.5rem' }}><strong>1.</strong> 프로젝트 구성</p>
            <p style={{ marginBottom: '0.5rem' }}><strong>2.</strong> 기술 스택 - 프론트엔드</p>
            <p style={{ marginBottom: '0.5rem' }}><strong>3.</strong> 기술 스택 - 백엔드</p>
          ...
          <div>
            ...
            <p style={{ marginBottom: '0.5rem' }}><strong>12.</strong> Overview</p>
          </div>
        </div>
      </div>
    </Slide>
